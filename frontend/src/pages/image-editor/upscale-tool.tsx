...
export const UpscaleControls: FC<Props> = ({ renderer, tool }) => {
        ...
        <>
            <div className="form-group" style={{ marginTop: "16px" }}>
                <button
                    ...
                    style={{ marginLeft: "8px" }}
                >
                    <i className="fas fa-download"></i>&nbsp; Upscale 2x
                </button>
            </div>
            <div className="form-group">
                <button
                    ...
                    style={{ marginLeft: "8px" }}
                >
                    <i className="fas fa-download"></i>&nbsp; Upscale 4x
                </button>
            </div>
        </>
    );
