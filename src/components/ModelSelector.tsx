...
const DALLE3_MODEL: StableDiffusionModel = {
    name: "dall-e-3",
    description:
        "Dalle3 by OpenAI. Note: Images generated by this model cost $0.04 each.",
    showcases: [],
    inpainting: false,
    activeModel: {} as any,
    available: true,
...
const ModelSelector: React.FC<ModelSelectorProps> = ({
    ...
    const [hordeModels, setHordeModels] = useCache<StableDiffusionModel[]>(
        "models",
        []
    );
    ...
    const combineModels = (
        hordeModels: StableDiffusionModel[]
    ): StableDiffusionModel[] => {
        return openaiEnabled ? [DALLE3_MODEL, ...hordeModels] : hordeModels;
    };

    const models: StableDiffusionModel[] = combineModels(hordeModels);
    ...
    useEffect(() => {
        const loadModels = async () => {
            ...
            if (!hordeModels || hordeModels.length === 0) {
                ...
                const combinedModels = combineModels(hordeModels);
                const selectedModel =
                    combinedModels.find(
